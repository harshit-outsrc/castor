...
from lambda_functions.canvas_events.events.logged_events import LoggedInEvent
...
class TestCanvasEventLoggedIn(unittest.TestCase):
    def setUp(self):
    ...
    def test_logged_in_event(self):
        test_event = test_events["logged_in"]
        handler = LoggedInEvent(
