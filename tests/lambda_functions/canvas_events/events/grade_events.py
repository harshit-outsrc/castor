...
from lambda_functions.canvas_events.events.grade_events import GradeChangeEvent
...
class TestCanvasEventGrade(unittest.TestCase):
    def setUp(self):
    ...
    def test_grade_change_event(self):
        test_event = test_events["grade_change"]
        handler = GradeChangeEvent(
